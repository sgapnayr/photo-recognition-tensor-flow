  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex items-center justify-center text-lg py-4">
        ...
        <div
          onClick={() => setLiveOrUploadMode('Tech Used')}
          className={`px-6 py-2 cursor-pointer font-semibold transition-opacity duration-300 text-gray-800 text-xl ${
            liveOrUploadMode === 'Tech Used' ? 'relative opacity-100' : 'hover:opacity-50 opacity-75'
          }`}
        >
          {liveOrUploadMode === 'Tech Used' && <div className="absolute left-0 right-0 bottom-0 h-[2px] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500" />}
          Tech Used
        </div>
        <div
